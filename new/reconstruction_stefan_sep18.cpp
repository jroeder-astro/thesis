...
// in the first round, use lambda=0 for optimization
  ...
  while (mcount < 20) {
    ...
    // calculate eps for the initial slope (slope from previous 
    // mcount solution) 
    // and a value below and above to determine whether slope_step should be 

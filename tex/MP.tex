...
various topics of physics, such as nuclear matter, quark matter and many others. Every one of these could potentially be modified
...
In order to generate an initial mass-radius relation to test the "inverse" algorithm with, one has to solve the TOV and
mass differential equation numerically. 
By looking at both equations, our ordinary differential equation [ODE] system is given in the form

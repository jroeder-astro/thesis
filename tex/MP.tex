...
\begin{figure} [h]
	...
	\caption{Ratio plots for the EOS that did not show peculiar behaviour. $\varepsilon_R$: reconstructed energy density, $\varepsilon_I$: default input energy density}
	\bigskip
	\label{fig:eos_ratio}
\end{figure}

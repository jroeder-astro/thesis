...
\def\apj{\ref@jnl{ApJ}}                 % Astrophysical Journ%al
%   ^^^^         ^^^^^ these do not seem to work properly... ??jnlApJ
...
This method is of course of highly numerical nature. However, in the past statistical approaches have often been of great success, which is why here a Monte Carlo method is used as a comparison. 



\subsection{Indirect radius check} \label{indradch}
...
%citetest
also lets have fun with \cite{Alford:2017qgh}

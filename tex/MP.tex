...
\begin{figure} [h]
	\centering
	\includegraphics[width=0.8\textwidth]{graphs_pdf/third_and_stable}
...
\begin{figure} [h]
	\centering
	\includegraphics[width=0.8\textwidth]{graphs_pdf/mrr_corr_eos_new}

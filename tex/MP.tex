...
In 2017 Alford and Sedrakian \cite{AlfordSedrakian(2017)} were the first to argue what effects a multiple phase QCD diagram would yield for new families of compact stars.  
...
The inversion of this ``standard'' problem was originally brought up by Gerlach in 1968, in a paper investigating the possibility of a third stable family \cite{Gerlach(1968)}; another well-established method was developed by Lindblom. Both methods shall be recalled here.\\
...
Lindblom on the other hand presents an MRR-EOS-pair to be uniquely linked by an abstract map \cite{Lindblom(1992)}. This gives rise to the possibility of using that map in the other direction, i.e. from MRR to EOS. His ``traditional'' solution of the inverse problem works as follows:\\
...
\begin{thebibliography}{2}
	...
	\bibitem{Gerlach(1968)} Gerlach, U.~H.\ 1968, Physical Review, \textbf{172}, 1325 
	\bibitem{AlfordSedrakian(2017)} Alford, M., \& Sedrakian, A.\ 2017, Physical Review Letters, \textbf{119}, 161104 
